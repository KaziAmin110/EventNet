...
// ];
// let uni_id = await insertUniversity(
//   0,
...
//         const publicEventRes = await eventService.createPublicEventRequestDB(
//           24,
//           eventRes
//         );
//         if (publicEventRes?.error) {
//           console.error(
//             `Public Event: "${e.event_name}" could not be inserted`
//           );
//         } else {
//           console.log(`Public Event: "${e.event_name}" inserted successfully`);
//           const universityEventRes = await eventService.createUniversityEventDB(
//             eventRes,
//             24,
//             uni_id
//           );
...
//             console.error(
//               `University Event: "${e.event_name}" could not be inserted`
//             );
//           } else {
//             console.log(
//               `University Event: "${e.event_name}" inserted successfully`
//             );
//           }
//         }
//       }
